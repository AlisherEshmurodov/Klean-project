                    ...
                    <div class="panel-body p-3">
                        ...
                        <form action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-group py-2">
                                ...
                                @error('name')
                                <p class="mb-0 ml-3 help-block text-danger">{{ $message }}</p>
{{--                                                        <div class="alert alert-danger">{{ $message }}</div>--}}
                            ...
                            <div class="form-group py-1 pb-2">
                                ...
                                @error('password')
                                <p class="ml-3 mb-0 help-block text-danger">{{ $message }}</p>
                                {{--                                                        <div class="alert alert-danger">{{ $message }}</div>--}}
                                @enderror
                            </div>
                            <div class="form-group py-1 pb-2">
                                ...
                                <p class="mb-0 ml-3 help-block text-danger">{{ str_replace('match', 'be same', $message) }}</p>
                                {{--                                                        <div class="alert alert-danger">{{ $message }}</div>--}}
                                @enderror
                            </div>
                            ...
                            <div class="text-center pt-4 text-muted">Already had an account?
